...
import { faHome, faBriefcase, faGraduationCap, IconDefinition, faCamera, faHeart, faStar, faMusic, faCoffee, faFlag, faBook, faEnvelope, faBicycle, faGlobe, faBell, faBolt, faAnchor, faLeaf, faFire, faGift, faPaw, faRocket } from '@fortawesome/free-solid-svg-icons'
