  ...
  const items: TabsProps['items'] = [
    {
      ...
      children: <div className="listMyDayContainer">
    ...
    },
    {
      ...
      children: <div className="card-container-progress py-2 align-content-center align-items-center row justify-content-between col-11 m-auto d-flex">
